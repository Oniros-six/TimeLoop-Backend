...
@Injectable()
export class PrismaCommerceConfigRepository implements ICommerceConfigRepository {
    ...
    async findCommerceConfig(data: { commerceId: number }): Promise<DomainClient | null> {
