...
@Injectable()
export class PrismaBookingHistoryRepository implements IBookingHistoryRepository {
    ...
    async findByCommerce(data: { commerceId: number; }): Promise<DomainClient[] | null> {
    ...
    async findByDates(data: { startDate: Date; endDate: Date; }): Promise<DomainClient[] | null> {
        const result = await this.prisma.bookingHistory.findMany({
            where: {
                AND: [
    ...
    async findByDatesAndCommerce(data: { commerceId: number; startDate: Date; endDate: Date; }): Promise<DomainClient[] | null> {
        const result = await this.prisma.bookingHistory.findMany({
            where: {
    ...
    async findByDatesAndUser(data: { userId: number; startDate: Date; endDate: Date; }): Promise<DomainClient[] | null> {
        const result = await this.prisma.bookingHistory.findMany({
            where: {
                userId: data.userId,
                AND: [
