...
export class TokenEncryptionService {
    ...
    encrypt(text: string): string {
        try {
            ...
            throw new Error(`Error encrypting data: ${error instanceof Error ? error.message : 'Unknown error'}`);
        }
    }
    ...
    decrypt(encryptedData: string): string {
        try {
            ...
            throw new Error(`Error decrypting data: ${error instanceof Error ? error.message : 'Unknown error'}`);
        }
    }
