...
@Injectable()
export class FindAllByCommerceDate {
    constructor(
    ...
    async execute(commerceId: number, data: { startPeriod: Date, endPeriod: Date }) {
        ...
        const invoices = await this.invoiceRepository.findAllByCommerceDate({
            commerceId: commerceId,
